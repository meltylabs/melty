	...
	if (isHuman) {
		return (
			<Collapsible className="bg-white border border-gray-200 rounded-md">
				<CollapsibleTrigger className="flex items-center text-xs justify-between w-full p-2 bg-white dark:bg-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800 rounded-t-md">
